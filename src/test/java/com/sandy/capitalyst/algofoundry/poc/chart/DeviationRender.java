package com.sandy.capitalyst.algofoundry.poc.chart;
 ...
 */
public class DeviationRender extends ApplicationFrame {
     ...
     */
    public DeviationRender(String title) {
        super(title);
    ...
    public static void main(String[] args) {
        ...
        DeviationRender demo = new DeviationRender(
